...
const EditPostPage = () => {
  ...
  useEffect(() => {
    // for api call to get post data to edit
  ...
  return (
    <Container maxWidth="80%">
      <AppBar position="static" sx={{ bgcolor: 'lightgray' }}>
        <Toolbar>
          <Typography variant="h7">Edit Post</Typography>
          <Grid container justifyContent="center" color={'black'}>
            <Button variant="text" color="inherit" sx={{ marginRight: '25px' }}>
              Edit
            </Button>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <label htmlFor="cover-image-input">
                <AddPhotoAlternateIcon
                  color="inherit"
                  sx={{ mt: 2, fontSize: 40, cursor: 'pointer' }}
                />
                <input
                  accept="image/*"
